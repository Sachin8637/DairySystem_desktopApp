...
$("#vendorList").on("change", function(e) {
   ...
   let vendor = vendorsData.filter(v =>{
    ...
    $("#add-item-sale").submit(async function(e) {
    ...
    //  Amount Function
$('#itemSaleWeight, #itemSaleRate').keyup(function(){
  var weight = parseFloat($('#itemSaleWeight').val()) || 0;
  var rate = parseFloat($('#itemSaleRate').val()) || 0;

  $('#itemSaleAmount').val(weight * rate);    
});
